...
export default function KeyFeatures() {
  return (
    <section className="grid lg:grid-cols-3 lg:gap-8 px-4 md:px-8 2xl:px-0 w-full max-w-[1080px] 2xl:max-w-[1280px] mx-auto py-20 lg:pb-32 2xl:py-40">
      {keyFeatures.map(({ title, desc, styles }, i) => (
        <div
          className={`py-12 md:py-16 lg:py-20 px-8 md:px-12 lg:px-16 ${styles}`}
          key={i}
        >
          <h1 className="questa text-xl lg:text-2xl mb-4 lg:mb-6">{title}</h1>
