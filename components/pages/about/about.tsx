export default function About() {
  return (
    <section className="flex flex-col lg:flex-row justify-center items-center w-full max-w-[1080px] 2xl:max-w-[1280px] mx-auto px-4 md:px-8 2xl:px-0 pt-20 lg:pt-24 2xl:pt-40 pb-32 2xl:pb-60">
      <div className="lg:w-1/2 lg:pr-8 mb-12 lg:mb-0 lg:mr-4">
        <h1 className="text-4xl lg:text-5xl questa mb-8 lg:mb-12 lg:max-w-[560px]">
          Kantor Jasa Akuntansi Azhar Maksum & Rekan
        </h1>
        <p className="mb-6 lg:mb-8 lg:max-w-[480px]">
