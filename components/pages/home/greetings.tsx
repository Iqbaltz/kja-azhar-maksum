...
export default function Greetings({ data }: Props) {
  return (
    <section className="pt-20 xl:pt-0 2xl:py-12">
      <div className="max-w-[1080px] 2xl:max-w-[1280px] px-4 md:px-8 xl:px-0 mx-auto flex flex-col lg:flex-row lg:justify-center lg:items-center">
